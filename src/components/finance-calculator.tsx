...
/**
 * The instalment / affordability calculator — the reusable core behind
 * the `/finance` page and the PDP's "Calculate Finance" dialog.
 */
export function FinanceCalculator({ initialPrice = "" }: { initialPrice?: string }) {
